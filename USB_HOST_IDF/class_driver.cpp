...
static void client_event_cb(const usb_host_client_event_msg_t *event_msg, void *arg)
{
    ...
    case USB_HOST_CLIENT_EVENT_NEW_DEV:
        ...
        driver_obj->mux_protected.device[event_msg->new_dev.address].actions |= (int)ACTION_OPEN_DEV;
        // Set flag
...
static void action_open_dev(usb_device_t *device_obj)
{
    ...
    device_obj->actions |= (int)ACTION_GET_DEV_INFO;
}
...
static void action_get_info(usb_device_t *device_obj)
{
    ...
    device_obj->actions |= (int)ACTION_GET_DEV_DESC;
}
...
static void action_get_dev_desc(usb_device_t *device_obj)
{
    ...
    device_obj->actions |= (int)ACTION_GET_CONFIG_DESC;
}
...
static void action_get_config_desc(usb_device_t *device_obj)
{
    ...
    device_obj->actions |= (int)ACTION_GET_STR_DESC;
}
